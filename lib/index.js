...
var VERBOSE, autoprefixer, fs, mapFilteredNodes, mapObj, path, postcss, postcss_advanced_variables, postcss_color_function, postcss_easy_import, postcss_extend, precss, sugarss, util;
  ...
  compile: function(filename, config, context, cb) {
    ...
    plugins = [
      postcss_easy_import({
        extensions: ['.sass'],
        path: ['css']
      }), precss, postcss_advanced_variables, postcss_color_function, postcss_extend
    ];
